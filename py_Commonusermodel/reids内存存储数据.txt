...
注意：
set 集合里有一个 setbit  name 99 1 ---这个name是设置元素的名字。这个99是个二进制的下标，最后一个1是设置他的这个下标99为1
getbit name 99  查看这个name里的99这个下标是0还是1
bitcount name 查看这个name里有多少个为1

------这个方法可以保存用户访问一类的数据做统计而且不消耗大量的内存
...
作者：closefrien_d1c2
链接：https://www.jianshu.com/p/4c86381ac0cc
來源：简书
